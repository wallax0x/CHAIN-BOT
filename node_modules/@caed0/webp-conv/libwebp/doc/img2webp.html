...
<p style="margin-left:1%; margin-top: 1em">img2webp -
...
<p style="margin-left:1%; margin-top: 1em"><b>img2webp</b>
[file_options] [[frame_options] frame_file]... [-o
webp_file] <b><br>
...
documents the <b>img2webp</b> command.</p>
...
&rsquo;-&rsquo;) is supplied as the argument, the command
line arguments are actually tokenized from this file. This
allows for easy scripting or using a large number of
arguments.</p>
...
<p style="margin-left:1%; margin-top: 1em">The file-level
...
<p style="margin-left:1%;"><b>-min_size</b></p>

<p style="margin-left:1%;">Encode images to achieve
smallest size. This disables key frame insertion and picks
the parameters resulting in the smallest output for each
frame. It uses lossless compression by default, but can be
combined with -q, -m, -lossy or -mixed options.</p>

<p style="margin-left:1%;"><b>-kmin</b> <i>int</i> <b><br>
-kmax</b> <i>int</i></p>

<p style="margin-left:1%;">Specify the minimum and maximum
...
<p style="margin-left:1%;"><b>-loop</b> <i>int</i></p>

<p style="margin-left:1%;">Specifies the number of times
the animation should loop. Using &rsquo;0&rsquo; means
&rsquo;loop indefinitely&rsquo;.</p>
...
<p style="margin-left:1%;">Print the version numbers of the
relevant libraries used.</p>
...
<p style="margin-left:1%; margin-top: 1em">The per-frame
...
<p style="margin-left:1%;"><b>-lossless, -lossy</b></p>

<p style="margin-left:1%;">Compress the next image(s) using
lossless or lossy compression mode. The default mode is
lossless.</p>
...
<p style="margin-left:1%;"><b>-exact, -noexact</b></p>

<p style="margin-left:1%;">Preserve or alter RGB values in
transparent area. The default is <b>-noexact</b>, to help
compressibility. Note <b>-noexact</b> may cause artifacts in
frames compressed with <b>-lossy</b>.</p>
...
problems during execution, <b>img2webp</b> exits with the
value of the C constant <b>EXIT_SUCCESS</b>. This is usually
zero.</p>

<p style="margin-left:1%; margin-top: 1em">If an error
occurs, <b>img2webp</b> exits with the value of the C
constant <b>EXIT_FAILURE</b>. This is usually one.</p>
...
<p style="margin-left:1%; margin-top: 1em">img2webp -loop 2
in0.png -lossy in1.jpg -d 80 in2.tiff -o out.webp</p>
