...
<!-- CreationDate: Fri Dec 13 10:12:07 2024 -->
...
<a href="#LOSSY OPTIONS">LOSSY OPTIONS</a><br>
<a href="#LOGGING OPTIONS">LOGGING OPTIONS</a><br>
...
<p style="margin-left:1%; margin-top: 1em">cwebp - compress
an image file to a WebP file</p>
...
<p style="margin-left:1%; margin-top: 1em"><b>cwebp</b>
...
documents the <b>cwebp</b> command.</p>

<p style="margin-left:1%; margin-top: 1em"><b>cwebp</b>
compresses an image using the WebP format. Input format can
be either PNG, JPEG, TIFF, WebP or raw Y&rsquo;CbCr samples.
Note: Animated PNG and WebP files are not supported.</p>
...
name will direct output to &rsquo;stdout&rsquo;.</p>
...
<p style="margin-left:1%;">A summary of all the possible
options.</p>
...
<p style="margin-left:1%;"><b>-lossless</b></p>

<p style="margin-left:1%;">Encode the image without any
...
<p style="margin-left:1%;"><b>-near_lossless</b>
<i>int</i></p>

<p style="margin-left:1%;">Specify the level of
...
<p style="margin-left:1%;"><b>-q</b> <i>float</i></p>

<p style="margin-left:1%;">Specify the compression factor
...
<p style="margin-left:1%;"><b>-alpha_q</b> <i>int</i></p>
...
<p style="margin-left:1%;"><b>-preset</b> <i>string</i></p>

<p style="margin-left:1%;">Specify a set of pre-defined
...
Since <b>-preset</b> overwrites the other parameters&rsquo;
...
larger file size and lower compression quality.</p></td>
<td width="92%">
</td></tr>
</table>
...
<p style="margin-left:1%;">Crop the source to a rectangle
...
rectangle. Note: the cropping is applied <i>before</i> any
scaling.</p>

<p style="margin-left:1%;"><b>-resize</b> <i>width
height</i></p>

<p style="margin-left:1%;">Resize the source to a rectangle
with size <b>width</b> x <b>height</b>. If either (but not
both) of the <b>width</b> or <b>height</b> parameters is 0,
the value will be calculated preserving the aspect-ratio.
Note: scaling is applied <i>after</i> cropping.</p>
...
<p style="margin-left:1%;"><b>-low_memory</b></p>

<p style="margin-left:1%;">Reduce memory usage of lossy
...
<h3>LOSSY OPTIONS
<a name="LOSSY OPTIONS"></a>
</h3>


<p style="margin-left:1%; margin-top: 1em">These options
are only effective when doing lossy encoding (the default,
with or without alpha). <b><br>
-size</b> <i>int</i></p>

<p style="margin-left:1%;">Specify a target size (in bytes)
...
<p style="margin-left:1%;"><b>-psnr</b> <i>float</i></p>

<p style="margin-left:1%;">Specify a target PSNR (in dB) to
try and reach for the compressed output. The compressor will
make several passes of partial encoding in order to get as
close as possible to this target. If both <b>-size</b> and
<b>-psnr</b> are used, <b>-size</b> value will prevail.</p>

<p style="margin-left:1%;"><b>-pass</b> <i>int</i></p>

<p style="margin-left:1%;">Set a maximum number of passes
...
passes will be used. If <b>-pass</b> is specified, but
neither <b>-size</b> nor <b>-psnr</b> are, a target PSNR of
40dB will be used.</p>

<p style="margin-left:1%;"><b>-qrange</b> <i>int
int</i></p>

<p style="margin-left:1%;">Specifies the permissible
interval for the quality factor. This is particularly useful
when using multi-pass (<b>-size</b> or <b>-psnr</b>
options). Default is 0 100. If the quality factor is outside
this range, it will be clamped. If the minimum value must be
less or equal to the maximum one.</p>
...
well-balanced quality.</p></td>
<td width="92%">
</td></tr>
</table>

<p style="margin-left:1%;"><b>-jpeg_like</b></p>

<p style="margin-left:1%;">Change the internal parameter
...
<p style="margin-left:1%;">Advanced options:</p>
...
<p style="margin-left:1%;"><b>-sharpness</b> <i>int</i></p>

<p style="margin-left:1%;">Specify the sharpness of the
filtering (if used). Range is 0 (sharpest) to 7 (least
sharp). Default is 0.</p>

<p style="margin-left:1%;"><b>-strong</b></p>

<p style="margin-left:1%;">Use strong filtering (if
filtering is being used thanks to the <b>-f</b> option).
Strong filtering is on by default.</p>

<p style="margin-left:1%;"><b>-nostrong</b></p>

<p style="margin-left:1%;">Disable strong filtering (if
filtering is being used thanks to the <b>-f</b> option) and
use simple filtering instead.</p>

<p style="margin-left:1%;"><b>-sharp_yuv</b></p>

<p style="margin-left:1%;">Use more accurate and sharper
RGB-&gt;YUV conversion. Note that this process is slower
than the default &rsquo;fast&rsquo; RGB-&gt;YUV
conversion.</p>

<p style="margin-left:1%;"><b>-sns</b> <i>int</i></p>

<p style="margin-left:1%;">Specify the amplitude of the
...
<p style="margin-left:1%;"><b>-segments</b> <i>int</i></p>

<p style="margin-left:1%;">Change the number of partitions
...
<p style="margin-left:1%;"><b>-partition_limit</b>
<i>int</i></p>

<p style="margin-left:1%;">Degrade quality by limiting the
...
only leaves room for a few bits per 16x16 macroblock. The
...
<b>-segments</b> option. Note the <b>-m</b> and <b>-q</b>
options also influence the encoder&rsquo;s decisions and
ability to hit this limit.</p>
...
<p style="margin-left:1%;"><b>-print_psnr</b></p>

<p style="margin-left:1%;">Compute and report average PSNR
(Peak-Signal-To-Noise ratio).</p>

<p style="margin-left:1%;"><b>-print_ssim</b></p>

<p style="margin-left:1%;">Compute and report average SSIM
(structural similarity metric, see
https://en.wikipedia.org/wiki/SSIM for additional
details).</p>

<p style="margin-left:1%;"><b>-print_lsim</b></p>

<p style="margin-left:1%;">Compute and report local
similarity metric (sum of lowest error amongst the
collocated pixel neighbors).</p>

<p style="margin-left:1%;"><b>-progress</b></p>

<p style="margin-left:1%;">Report encoding progress in
percent.</p>
...
for testing purposes.</p></td>
<td width="92%">
</td></tr>
</table>

<p style="margin-left:1%;"><b>-map</b> <i>int</i></p>

<p style="margin-left:1%;">Output additional ASCII-map of
...
<p style="margin-left:1%; margin-top: 1em">More advanced
options are: <b><br>
-s</b> <i>width height</i></p>

<p style="margin-left:1%;">Specify that the input file
...
<p style="margin-left:1%;"><b>-pre</b> <i>int</i></p>

<p style="margin-left:1%;">Specify some preprocessing
...
<p style="margin-left:1%;"><b>-alpha_filter</b>
<i>string</i></p>

<p style="margin-left:1%;">Specify the predictive filtering
method for the alpha plane. One of &rsquo;none&rsquo;,
&rsquo;fast&rsquo; or &rsquo;best&rsquo;, in increasing
complexity and slowness order. Default is
&rsquo;fast&rsquo;. Internally, alpha filtering is performed
using four possible predictions (none, horizontal, vertical,
gradient). The &rsquo;best&rsquo; mode will try each mode in
turn and pick the one which gives the smaller size. The
&rsquo;fast&rsquo; mode will just try to form an a priori
guess without testing all modes.</p>

<p style="margin-left:1%;"><b>-alpha_method</b>
<i>int</i></p>

<p style="margin-left:1%;">Specify the algorithm used for
...
off, to help compressibility.</p></td>
<td width="92%">
</td></tr>
</table>

<p style="margin-left:1%;"><b>-blend_alpha</b>
<i>int</i></p>

<p style="margin-left:1%;">This option blends the alpha
...
<p style="margin-left:1%;"><b>-noalpha</b></p>

<p style="margin-left:1%;">Using this option will discard
the alpha channel.</p>

<p style="margin-left:1%;"><b>-hint</b> <i>string</i></p>

<p style="margin-left:1%;">Specify the hint about input
image type. Possible values are: <b>photo</b>,
<b>picture</b> or <b>graph</b>.</p>

<p style="margin-left:1%;"><b>-metadata</b>
<i>string</i></p>

<p style="margin-left:1%;">A comma separated list of
...
<p style="margin-left:1%; margin-top: 1em">Note: each input
format may not support all combinations.</p>
...
<p style="margin-left:1%; margin-top: 1em">If there were no
problems during execution, <b>cwebp</b> exits with the value
of the C constant <b>EXIT_SUCCESS</b>. This is usually
zero.</p>

<p style="margin-left:1%; margin-top: 1em">If an error
occurs, <b>cwebp</b> exits with the value of the C constant
<b>EXIT_FAILURE</b>. This is usually one.</p>
...
<p style="margin-left:1%; margin-top: 1em">cwebp -q 50
...
<p style="margin-left:1%; margin-top: 1em"><b>cwebp</b> is
...
https://issues.webmproject.org <br>
